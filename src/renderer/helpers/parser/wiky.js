...
var Wiky = {
  ...
  rules: {
    ...
    stender: [
      ...
      {
        rex: /\[{2}(.+?)\|(.+?)\]{2}/g, tmplt: function ($0, $1, $2) {
      ...
      {
        rex: /\{{2}גופן\|(\d)\|{2}(.+?)\}{2}/g, tmplt: function ($0, $1, $2) {
          let fontSize = 0.5 * $1;
    ...
    hide: [
      { rex: /\{{2}(הועלה אוטומטית|ניווט כללי עליון|ניווט כללי תחתון|פורסם בנחלת הכלל|שולי הגליון|הערות שוליים|ocr)\}{2}/g, tmplt: "" },
    ],
    lang: {}
  },
